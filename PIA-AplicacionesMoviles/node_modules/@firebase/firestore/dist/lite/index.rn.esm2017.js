...
class {
    ...
    A(t, e, n, r, s) {
        const i = dt(), o = this.I(t, e);
        _("RestConnection", `Sending RPC '${t}' ${i}:`, o, n);
        const u = {};
        return this.T(u, r, s), this.R(t, o, u, n).then((e => (_("RestConnection", `Received RPC '${t}' ${i}: `, e), 
        e)), (e => {
 ...
 */ function Ne(t) {
    ...
    if (null === e.k) {
        ...
        t.isKeyField() || e.k.push(new de(t)), e.k.push(new de(st.keyField(), "asc" /* Direction.ASCENDING */)); else {
            let t = !1;
 ...
 */ function De(t) {
    const e = T(t);
    if (!e.C) if ("F" /* LimitType.First */ === e.limitType) e.C = Te(e.path, e.collectionGroup, Ne(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.C = Te(e.path, e.collectionGroup, t, e.filters, e.limit, n, r);
    }
    return e.C;
}
...
async function bn(t, e) {
    const n = T(t), r = on(n.M) + "/documents", s = {
        writes: e.map((t => an(n.M, t)))
    };
...
function Mn(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Tt.F()), ot("doc", "path", e), t instanceof Vn) {
        const r = nt.fromString(e, ...n);
...
/** A "context" object passed around while parsing user data. */ class Jn {
    ...
    /** Returns a new context with the specified settings overwritten. */    it(t) {
        return new Jn(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.M, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    ot(t) {
        var e;
    ...
    lt(t) {
        return gr(t, this.settings.methodName, this.settings.ft || !1, this.path, this.settings.dt);
    }
    ...
    ct(t) {
        ...
        if (Zn(this.st) && Kn.test(t)) throw this.lt('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Xn {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || gn(t);
    }
...
class ir extends Wn {
    ...
    _toFieldTransform(t) {
        const e = rr(this, t, 
        /*array=*/ !0), n = this.yt.map((t => lr(t, e))), r = new ke(n);
...
class or extends Wn {
    ...
    _toFieldTransform(t) {
        const e = rr(this, t, 
        /*array=*/ !0), n = this.yt.map((t => lr(t, e))), r = new Ce(n);
        return new Me(t.path, r);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class ur extends Wn {
    ...
    _toFieldTransform(t) {
        const e = new Le(t.M, Se(t.M, this.gt));
...
/** Parse update data from a list of field/value arguments. */ function ar(t, e, n, r, s, i) {
    const o = t.wt(1 /* UserDataSource.Update */ , e, n), u = [ mr(e, r, n) ], c = [ s ];
 ...
 */ function hr(t, e, n, r = !1) {
    return lr(n, t.wt(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!Zn(e.st)) throw e.lt(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Se(e.M, t);
        ...
        if (t instanceof Bn) return {
            bytesValue: Je(e.M, t._byteString)
        };
        if (t instanceof qn) {
...
class bs {
    constructor(t, e, n, r, s) {
        ...
        this.deferred = s, this._t = n.maxAttempts, this.vt = new _n(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    ...
    bt() {
        this.vt.J((async () => {
            const t = new _s(this.datastore), e = this.Et(t);
            e && e.then((e => {
 ...
 */ class Is {
    constructor() {
        ...
        this.vt = new _n(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const r = As.createAndSchedule(this, t, e, n, (t => this.kt(t)));
...
r("firestore-lite", "3.9.0", "rn"), r("firestore-lite", "3.9.0", "esm2017");
