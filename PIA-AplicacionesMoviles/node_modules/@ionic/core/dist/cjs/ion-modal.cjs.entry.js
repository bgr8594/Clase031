...
const Modal = class {
  constructor(hostRef) {
    ...
    this.configureTriggerInteraction = () => {
      ...
      if (!triggerEl) {
        index$4.printIonWarning(`A trigger element with the ID "${trigger}" was not found in the DOM. The trigger element must be in the DOM when the "trigger" property is set on ion-modal.`, this.el);
        return;
      }
  ...
  async present() {
    ...
    this.usersElement = await frameworkDelegate.attachComponent(delegate, this.el, this.component, ['ion-page'], this.componentProps, inline);
