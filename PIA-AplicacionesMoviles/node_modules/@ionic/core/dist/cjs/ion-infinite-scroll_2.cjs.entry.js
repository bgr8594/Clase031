...
const index$2 = require('./index-a2159ff5.js');
...
const InfiniteScrollContent = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: "infinite-loading" }, this.loadingSpinner && (index.h("div", { class: "infinite-loading-spinner" }, index.h("ion-spinner", { name: this.loadingSpinner }))), this.loadingText !== undefined && (index.h("div", { class: "infinite-loading-text", innerHTML: index$2.sanitizeDOMString(this.loadingText) })))));
  }
};
